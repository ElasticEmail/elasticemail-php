...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.elasticemail.com/v4';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/4.0.20/PHP';
    ...
    {
        $report  = 'PHP SDK (ElasticEmail) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 4.0.0' . PHP_EOL;
        $report .= '    SDK Package Version: 4.0.20' . PHP_EOL;
