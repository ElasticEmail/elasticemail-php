...
class EmailContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets merge
     *
     * @param map[string,string]|null $merge A key-value collection of custom merge fields, shared between recipients. Should be used in e-mail body like so: {firstname}, {lastname} etc.
     *
     * @return self
     */
     ...
     * Sets headers
     *
     * @param map[string,string]|null $headers A key-value collection of custom e-mail headers.
     *
     * @return self
     */
