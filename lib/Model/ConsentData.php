...
class ConsentData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('consent_tracking', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($consent_ip)) {
            throw new \InvalidArgumentException('non-nullable consent_ip cannot be null');
        }
    ...
    public function setConsentDate($consent_date)
    {
        if (is_null($consent_date)) {
            array_push($this->openAPINullablesSetToNull, 'consent_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('consent_date', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($consent_tracking)) {
            throw new \InvalidArgumentException('non-nullable consent_tracking cannot be null');
        }
