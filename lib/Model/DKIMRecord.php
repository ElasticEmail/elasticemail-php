...
/**
 * DKIMRecord Class Doc Comment
 *
 * @category Class
 * @description Content of the DKIM record to be added to DNS for the domain.
 * @package  ElasticEmail
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DKIMRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DKIMRecord';
