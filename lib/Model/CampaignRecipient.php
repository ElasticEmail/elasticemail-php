...
class CampaignRecipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets list_names
     *
     * @param string[]|null $list_names Names of lists from your Account to read recipients from
     *
     * @return self
     */
    public function setListNames($list_names)
    {
        if (is_null($list_names)) {
            throw new \InvalidArgumentException('non-nullable list_names cannot be null');
        }
     ...
     * Sets segment_names
     *
     * @param string[]|null $segment_names Names of segments from your Account to read recipients from
     *
     * @return self
     */
    public function setSegmentNames($segment_names)
    {
        if (is_null($segment_names)) {
            throw new \InvalidArgumentException('non-nullable segment_names cannot be null');
        }
