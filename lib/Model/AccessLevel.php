...
class AccessLevel
{
    ...
    public const VIEW_VERIFY_EMAILS = 'ViewVerifyEmails';

    public const VIEW_ACCESS_TOKENS = 'ViewAccessTokens';

    public const VIEW_WEB_NOTIFICATIONS = 'ViewWebNotifications';
    ...
    public const VIEW_AI_TOOLS = 'ViewAITools';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::VERIFY_EMAILS,
            self::MODIFY2_FA_SMS,
            self::VIEW_VERIFY_EMAILS,
            self::VIEW_ACCESS_TOKENS,
            self::VIEW_WEB_NOTIFICATIONS,
