...
class InboundPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('http_address', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets filter_type
     *
     * @param \ElasticEmail\Model\InboundRouteFilterType $filter_type filter_type
     *
     * @return self
     */
     ...
     * Sets action_type
     *
     * @param \ElasticEmail\Model\InboundRouteActionType $action_type action_type
     *
     * @return self
     */
    ...
    {
        if (is_null($http_address)) {
            throw new \InvalidArgumentException('non-nullable http_address cannot be null');
        }
