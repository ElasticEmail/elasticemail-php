...
/**
 * ListUpdatePayload Class Doc Comment
 *
 * @category Class
 * @package  ElasticEmail
 * @author   OpenAPI Generator team
 ...
 */
class ListUpdatePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListUpdatePayload';
    ...
    {
        $this->setIfExists('new_list_name', $data ?? [], null);
    ...
    */
     ...
     * Sets new_list_name
     *
     * @param string|null $new_list_name Name of your list if you want to change it.
     *
     * @return self
     */
    public function setNewListName($new_list_name)
    {
        if (is_null($new_list_name)) {
            throw new \InvalidArgumentException('non-nullable new_list_name cannot be null');
        }
