...
class ExportLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $public_export_id ID of the exported file
     *
     * @return self
     */
    public function setPublicExportId($public_export_id)
    {
        if (is_null($public_export_id)) {
            throw new \InvalidArgumentException('non-nullable public_export_id cannot be null');
        }
