...
class CampaignOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param DeliveryOptimizationType|null $delivery_optimization How to order email delivery - by recipients' engagement score or by the time they open the most of the emails that were sent to them
     *
     * @return self
     */
     ...
     * Sets split_options
     *
     * @param SplitOptions|null $split_options Optional options for A/X split campaigns. Will be ignored if only one template content was provided
     *
     * @return self
     */
