...
class SubAccountInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['public_account_id'] = $data['public_account_id'] ?? null;
        $this->container['email'] = $data['email'] ?? null;
        $this->container['settings'] = $data['settings'] ?? null;
        $this->container['last_activity'] = $data['last_activity'] ?? null;
        $this->container['email_credits'] = $data['email_credits'] ?? null;
        $this->container['total_emails_sent'] = $data['total_emails_sent'] ?? null;
        $this->container['reputation'] = $data['reputation'] ?? null;
        $this->container['status'] = $data['status'] ?? null;
        $this->container['contacts_count'] = $data['contacts_count'] ?? null;
    }
