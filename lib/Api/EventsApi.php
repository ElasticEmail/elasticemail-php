...
class EventsApi
{
     ...
     * @param  \DateTime|null $from Starting date for search in YYYY-MM-DDThh:mm:ss format. (optional)
     * @param  \DateTime|null $to Ending date for search in YYYY-MM-DDThh:mm:ss format. (optional)
     * @param  \ElasticEmail\Model\EventsOrderBy|null $order_by order_by (optional)
     ...
     * @param  \DateTime|null $from Starting date for search in YYYY-MM-DDThh:mm:ss format. (optional)
     * @param  \DateTime|null $to Ending date for search in YYYY-MM-DDThh:mm:ss format. (optional)
     * @param  \ElasticEmail\Model\EventsOrderBy|null $order_by (optional)
     * @param  int|null $limit Maximum number of returned items. (optional)
     * @param  int|null $offset How many items should be returned ahead. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['eventsByTransactionidGet'] to see the possible values for this operation
     *
     ...
     * @param  \ElasticEmail\Model\EventType[]|null $event_types Types of Events to return (optional)
     * @param  \DateTime|null $from Starting date for search in YYYY-MM-DDThh:mm:ss format. (optional)
     * @param  \DateTime|null $to Ending date for search in YYYY-MM-DDThh:mm:ss format. (optional)
     ...
     * @param  \DateTime|null $to Ending date for search in YYYY-MM-DDThh:mm:ss format. (optional)
     * @param  \ElasticEmail\Model\EventsOrderBy|null $order_by order_by (optional)
     * @param  int|null $limit How many items to load. Maximum for this request is 1000 items (optional)
     * @param  int|null $offset How many items should be returned ahead. (optional)
