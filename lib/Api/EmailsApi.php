...
class EmailsApi
{
     ...
     * @param  bool|null $show_failed Include Bounced email addresses. (optional, default to false)
     * @param  bool|null $show_sent Include Sent email addresses. (optional, default to false)
     * @param  bool|null $show_delivered Include all delivered email addresses. (optional, default to false)
     * @param  bool|null $show_pending Include Ready to send email addresses. (optional, default to false)
     * @param  bool|null $show_opened Include Opened email addresses. (optional, default to false)
     * @param  bool|null $show_clicked Include Clicked email addresses. (optional, default to false)
     * @param  bool|null $show_abuse Include Reported as abuse email addresses. (optional, default to false)
     * @param  bool|null $show_unsubscribed Include Unsubscribed email addresses. (optional, default to false)
     * @param  bool|null $show_errors Include error messages for bounced emails. (optional, default to false)
     * @param  bool|null $show_message_ids Include all MessageIDs for this transaction (optional, default to false)
