...
class CampaignsApi
{
    ...
    /**
     * Operation campaignsAutomationByNameTriggerPost
     *
     * Trigger Automation for Contact
     *
     * @param  string $name name (required)
     * @param  string $contact_email contact_email (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['campaignsAutomationByNameTriggerPost'] to see the possible values for this operation
     *
     * @throws \ElasticEmail\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function campaignsAutomationByNameTriggerPost($name, $contact_email, string $contentType = self::contentTypes['campaignsAutomationByNameTriggerPost'][0])
    {
        $this->campaignsAutomationByNameTriggerPostWithHttpInfo($name, $contact_email, $contentType);
    }

    /**
     * Operation campaignsAutomationByNameTriggerPostWithHttpInfo
     *
     * Trigger Automation for Contact
     *
     ...
     */
    public function campaignsAutomationByNameTriggerPostWithHttpInfo($name, $contact_email, string $contentType = self::contentTypes['campaignsAutomationByNameTriggerPost'][0])
    {
        $request = $this->campaignsAutomationByNameTriggerPostRequest($name, $contact_email, $contentType);
    ...
    /**
     * Operation campaignsAutomationByNameTriggerPostAsync
     *
     * Trigger Automation for Contact
     *
     * @param  string $name (required)
     ...
     */
    public function campaignsAutomationByNameTriggerPostAsync($name, $contact_email, string $contentType = self::contentTypes['campaignsAutomationByNameTriggerPost'][0])
    {
        return $this->campaignsAutomationByNameTriggerPostAsyncWithHttpInfo($name, $contact_email, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation campaignsAutomationByNameTriggerPostAsyncWithHttpInfo
     *
     * Trigger Automation for Contact
     *
     * @param  string $name (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function campaignsAutomationByNameTriggerPostAsyncWithHttpInfo($name, $contact_email, string $contentType = self::contentTypes['campaignsAutomationByNameTriggerPost'][0])
    {
        $returnType = '';
        $request = $this->campaignsAutomationByNameTriggerPostRequest($name, $contact_email, $contentType);
    ...
    /**
     * Create request for operation 'campaignsAutomationByNameTriggerPost'
     *
     * @param  string $name (required)
     * @param  string $contact_email (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['campaignsAutomationByNameTriggerPost'] to see the possible values for this operation
     ...
     */
    public function campaignsAutomationByNameTriggerPostRequest($name, $contact_email, string $contentType = self::contentTypes['campaignsAutomationByNameTriggerPost'][0])
    {

        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling campaignsAutomationByNameTriggerPost'
            );
        }
        ...
        if ($contact_email === null || (is_array($contact_email) && count($contact_email) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contact_email when calling campaignsAutomationByNameTriggerPost'
            );
        }


        $resourcePath = '/campaigns/automation/{name}/trigger';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Load Campaigns
     *
     * @param  string|null $search Text fragment used for searching in Campaign name (using the &#39;contains&#39; rule) (optional)
