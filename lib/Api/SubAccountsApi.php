...
class SubAccountsApi
{
    ...
    /**
     * Operation subaccountsByEmailApikeyGet
     *
     * Get SubAccount ApiKey
     *
     * @param  string $email Email address of Sub-Account (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['subaccountsByEmailApikeyGet'] to see the possible values for this operation
     *
     * @throws \ElasticEmail\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return string
     */
    public function subaccountsByEmailApikeyGet($email, string $contentType = self::contentTypes['subaccountsByEmailApikeyGet'][0])
    {
        list($response) = $this->subaccountsByEmailApikeyGetWithHttpInfo($email, $contentType);
        return $response;
    }

    /**
     * Operation subaccountsByEmailApikeyGetWithHttpInfo
     *
     * Get SubAccount ApiKey
     *
     * @param  string $email Email address of Sub-Account (required)
     ...
     */
    public function subaccountsByEmailApikeyGetWithHttpInfo($email, string $contentType = self::contentTypes['subaccountsByEmailApikeyGet'][0])
    {
        $request = $this->subaccountsByEmailApikeyGetRequest($email, $contentType);
    ...
    /**
     * Operation subaccountsByEmailApikeyGetAsync
     *
     * Get SubAccount ApiKey
     *
     * @param  string $email Email address of Sub-Account (required)
     ...
     */
    public function subaccountsByEmailApikeyGetAsync($email, string $contentType = self::contentTypes['subaccountsByEmailApikeyGet'][0])
    {
        return $this->subaccountsByEmailApikeyGetAsyncWithHttpInfo($email, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation subaccountsByEmailApikeyGetAsyncWithHttpInfo
     *
     * Get SubAccount ApiKey
     *
     * @param  string $email Email address of Sub-Account (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function subaccountsByEmailApikeyGetAsyncWithHttpInfo($email, string $contentType = self::contentTypes['subaccountsByEmailApikeyGet'][0])
    {
        $returnType = 'string';
        $request = $this->subaccountsByEmailApikeyGetRequest($email, $contentType);
    ...
    /**
     * Create request for operation 'subaccountsByEmailApikeyGet'
     *
     * @param  string $email Email address of Sub-Account (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['subaccountsByEmailApikeyGet'] to see the possible values for this operation
     *
     ...
     */
    public function subaccountsByEmailApikeyGetRequest($email, string $contentType = self::contentTypes['subaccountsByEmailApikeyGet'][0])
    {

        // verify the required parameter 'email' is set
        if ($email === null || (is_array($email) && count($email) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email when calling subaccountsByEmailApikeyGet'
            );
        }


        $resourcePath = '/subaccounts/{email}/apikey';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function subaccountsByEmailCreditsPatchRequest($email, $subaccount_email_credits_payload, string $contentType = self::contentTypes['subaccountsByEmailCreditsPatch'][0])
    {
        ...
        if (isset($subaccount_email_credits_payload)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($subaccount_email_credits_payload));
            } else {
    ...
    public function subaccountsByEmailSettingsEmailPutRequest($email, $subaccount_email_settings, string $contentType = self::contentTypes['subaccountsByEmailSettingsEmailPut'][0])
    {
        ...
        if (isset($subaccount_email_settings)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($subaccount_email_settings));
            } else {
    ...
    public function subaccountsPostRequest($subaccount_payload, string $contentType = self::contentTypes['subaccountsPost'][0])
    {
        ...
        if (isset($subaccount_payload)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($subaccount_payload));
            } else {
