...
class ContactsApi
{
    ...
    {
        $this->contactsByEmailDeleteWithHttpInfo($email);
    }
     ...
     */
    public function contactsByEmailDeleteWithHttpInfo($email)
    {
        $request = $this->contactsByEmailDeleteRequest($email);
     ...
     */
    public function contactsByEmailDeleteAsync($email)
    {
        return $this->contactsByEmailDeleteAsyncWithHttpInfo($email)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsByEmailDeleteAsyncWithHttpInfo($email)
    {
        $returnType = '';
        $request = $this->contactsByEmailDeleteRequest($email);
     ...
     */
    public function contactsByEmailDeleteRequest($email)
    {
    ...
    {
        list($response) = $this->contactsByEmailGetWithHttpInfo($email);
        return $response;
    }
     ...
     */
    public function contactsByEmailGetWithHttpInfo($email)
    {
        $request = $this->contactsByEmailGetRequest($email);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsByEmailGetAsync($email)
    {
        return $this->contactsByEmailGetAsyncWithHttpInfo($email)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsByEmailGetAsyncWithHttpInfo($email)
    {
        $returnType = '\ElasticEmail\Model\Contact';
        $request = $this->contactsByEmailGetRequest($email);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function contactsByEmailGetRequest($email)
    {
        // verify the required parameter 'email' is set
        if ($email === null || (is_array($email) && count($email) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->contactsByEmailHistoryGetWithHttpInfo($email, $limit, $offset);
        return $response;
    }

    /**
     * Operation contactsByEmailHistoryGetWithHttpInfo
     *
     * Load History
     *
     * @param  string $email Proper email address. (required)
     ...
     * @throws \ElasticEmail\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ElasticEmail\Model\ContactHistory[], HTTP status code, HTTP response headers (array of strings)
     */
    public function contactsByEmailHistoryGetWithHttpInfo($email, $limit = null, $offset = null)
    {
        $request = $this->contactsByEmailHistoryGetRequest($email, $limit, $offset);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ElasticEmail\Model\ContactHistory[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ElasticEmail\Model\ContactHistory[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ElasticEmail\Model\ContactHistory[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    /**
     * Operation contactsByEmailHistoryGetAsync
     *
     * Load History
     *
     * @param  string $email Proper email address. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsByEmailHistoryGetAsync($email, $limit = null, $offset = null)
    {
        return $this->contactsByEmailHistoryGetAsyncWithHttpInfo($email, $limit, $offset)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation contactsByEmailHistoryGetAsyncWithHttpInfo
     *
     * Load History
     *
     * @param  string $email Proper email address. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsByEmailHistoryGetAsyncWithHttpInfo($email, $limit = null, $offset = null)
    {
        $returnType = '\ElasticEmail\Model\ContactHistory[]';
        $request = $this->contactsByEmailHistoryGetRequest($email, $limit, $offset);
    ...
    /**
     * Create request for operation 'contactsByEmailHistoryGet'
     *
     * @param  string $email Proper email address. (required)
     * @param  int $limit Maximum number of returned items. (optional)
     * @param  int $offset How many items should be returned ahead. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function contactsByEmailHistoryGetRequest($email, $limit = null, $offset = null)
    {
        // verify the required parameter 'email' is set
        if ($email === null || (is_array($email) && count($email) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email when calling contactsByEmailHistoryGet'
            );
        }
     ...
     * @return \ElasticEmail\Model\Contact
     */
    public function contactsByEmailPut($email, $contact_update_payload)
    {
        list($response) = $this->contactsByEmailPutWithHttpInfo($email, $contact_update_payload);
        return $response;
    }
     ...
     * @return array of \ElasticEmail\Model\Contact, HTTP status code, HTTP response headers (array of strings)
     */
    public function contactsByEmailPutWithHttpInfo($email, $contact_update_payload)
    {
        $request = $this->contactsByEmailPutRequest($email, $contact_update_payload);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsByEmailPutAsync($email, $contact_update_payload)
    {
        return $this->contactsByEmailPutAsyncWithHttpInfo($email, $contact_update_payload)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsByEmailPutAsyncWithHttpInfo($email, $contact_update_payload)
    {
        $returnType = '\ElasticEmail\Model\Contact';
        $request = $this->contactsByEmailPutRequest($email, $contact_update_payload);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function contactsByEmailPutRequest($email, $contact_update_payload)
    {
        // verify the required parameter 'email' is set
        if ($email === null || (is_array($email) && count($email) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return void
     */
    public function contactsDeletePost($emails_payload)
    {
        $this->contactsDeletePostWithHttpInfo($emails_payload);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function contactsDeletePostWithHttpInfo($emails_payload)
    {
        $request = $this->contactsDeletePostRequest($emails_payload);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsDeletePostAsync($emails_payload)
    {
        return $this->contactsDeletePostAsyncWithHttpInfo($emails_payload)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsDeletePostAsyncWithHttpInfo($emails_payload)
    {
        $returnType = '';
        $request = $this->contactsDeletePostRequest($emails_payload);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function contactsDeletePostRequest($emails_payload)
    {
    ...
    {
        list($response) = $this->contactsExportByIdStatusGetWithHttpInfo($id);
        return $response;
    }
     ...
     */
    public function contactsExportByIdStatusGetWithHttpInfo($id)
    {
        $request = $this->contactsExportByIdStatusGetRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsExportByIdStatusGetAsync($id)
    {
        return $this->contactsExportByIdStatusGetAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsExportByIdStatusGetAsyncWithHttpInfo($id)
    {
        $returnType = '\ElasticEmail\Model\ExportStatus';
        $request = $this->contactsExportByIdStatusGetRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function contactsExportByIdStatusGetRequest($id)
    {
     ...
     */
    public function contactsExportPost($file_format = null, $rule = null, $emails = null, $compression_format = null, $file_name = null)
    {
        list($response) = $this->contactsExportPostWithHttpInfo($file_format, $rule, $emails, $compression_format, $file_name);
        return $response;
    }
     ...
     */
    public function contactsExportPostWithHttpInfo($file_format = null, $rule = null, $emails = null, $compression_format = null, $file_name = null)
    {
        $request = $this->contactsExportPostRequest($file_format, $rule, $emails, $compression_format, $file_name);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsExportPostAsync($file_format = null, $rule = null, $emails = null, $compression_format = null, $file_name = null)
    {
        return $this->contactsExportPostAsyncWithHttpInfo($file_format, $rule, $emails, $compression_format, $file_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsExportPostAsyncWithHttpInfo($file_format = null, $rule = null, $emails = null, $compression_format = null, $file_name = null)
    {
        $returnType = '\ElasticEmail\Model\ExportLink';
        $request = $this->contactsExportPostRequest($file_format, $rule, $emails, $compression_format, $file_name);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function contactsExportPostRequest($file_format = null, $rule = null, $emails = null, $compression_format = null, $file_name = null)
    {
    ...
    {
        list($response) = $this->contactsGetWithHttpInfo($limit, $offset);
        return $response;
    }
     ...
     * @return array of \ElasticEmail\Model\Contact[], HTTP status code, HTTP response headers (array of strings)
     */
    public function contactsGetWithHttpInfo($limit = null, $offset = null)
    {
        $request = $this->contactsGetRequest($limit, $offset);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsGetAsync($limit = null, $offset = null)
    {
        return $this->contactsGetAsyncWithHttpInfo($limit, $offset)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsGetAsyncWithHttpInfo($limit = null, $offset = null)
    {
        $returnType = '\ElasticEmail\Model\Contact[]';
        $request = $this->contactsGetRequest($limit, $offset);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function contactsGetRequest($limit = null, $offset = null)
    {
     ...
     * @return void
     */
    public function contactsImportPost($list_name = null, $encoding_name = null, $file = null)
    {
        $this->contactsImportPostWithHttpInfo($list_name, $encoding_name, $file);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function contactsImportPostWithHttpInfo($list_name = null, $encoding_name = null, $file = null)
    {
        $request = $this->contactsImportPostRequest($list_name, $encoding_name, $file);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsImportPostAsync($list_name = null, $encoding_name = null, $file = null)
    {
        return $this->contactsImportPostAsyncWithHttpInfo($list_name, $encoding_name, $file)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsImportPostAsyncWithHttpInfo($list_name = null, $encoding_name = null, $file = null)
    {
        $returnType = '';
        $request = $this->contactsImportPostRequest($list_name, $encoding_name, $file);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function contactsImportPostRequest($list_name = null, $encoding_name = null, $file = null)
    {
        ...
        // query params
        if ($list_name !== null) {
            if('form' === 'form' && is_array($list_name)) {
                foreach($list_name as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['listName'] = $list_name;
            }
        }
        // query params
        if ($encoding_name !== null) {
            if('form' === 'form' && is_array($encoding_name)) {
                foreach($encoding_name as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['encodingName'] = $encoding_name;
            }
        }
     ...
     * @return \ElasticEmail\Model\Contact[]
     */
    public function contactsPost($contact_payload, $listnames = null)
    {
        list($response) = $this->contactsPostWithHttpInfo($contact_payload, $listnames);
        return $response;
    }
     ...
     * @return array of \ElasticEmail\Model\Contact[], HTTP status code, HTTP response headers (array of strings)
     */
    public function contactsPostWithHttpInfo($contact_payload, $listnames = null)
    {
        $request = $this->contactsPostRequest($contact_payload, $listnames);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsPostAsync($contact_payload, $listnames = null)
    {
        return $this->contactsPostAsyncWithHttpInfo($contact_payload, $listnames)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contactsPostAsyncWithHttpInfo($contact_payload, $listnames = null)
    {
        $returnType = '\ElasticEmail\Model\Contact[]';
        $request = $this->contactsPostRequest($contact_payload, $listnames);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function contactsPostRequest($contact_payload, $listnames = null)
    {
        ...
        // query params
        if ($listnames !== null) {
            if('form' === 'form' && is_array($listnames)) {
                foreach($listnames as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['listnames'] = $listnames;
            }
        }
