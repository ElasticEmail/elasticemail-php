...
class ContactsApi
{
     ...
     * Export Contacts
     *
     * @param  \ElasticEmail\Model\ExportFileFormats|null $file_format Format of the exported file (optional)
     * @param  string|null $rule Query used for filtering. (optional)
     * @param  string[]|null $emails Comma delimited list of contact emails (optional)
     * @param  \ElasticEmail\Model\CompressionFormat|null $compression_format FileResponse compression format. None or Zip. (optional)
     * @param  string|null $file_name Name of your file including extension. (optional)
     ...
     * Upload Contacts
     *
     * @param  string|null $list_name Name of an existing list to add these contacts to (optional)
     * @param  string|null $encoding_name In what encoding the file is uploaded (optional)
     * @param  string|null $file_url Optional url of csv to import (optional)
     ...
     * @param  string[]|null $listnames Names of lists to which the uploaded contacts should be added to (optional)
