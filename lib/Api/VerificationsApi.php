...
class VerificationsApi
{
     ...
     * @param  int|null $limit Maximum number of returned email verification results (optional)
     * @param  int|null $offset How many result items should be returned ahead (optional)
